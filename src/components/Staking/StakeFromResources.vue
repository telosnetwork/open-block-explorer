      ...
      .col-12
        .row
          .row.q-pb-sm.full-width
            ...
            .col-3.text-weight-bold.text-right.cursor-pointer.q-hoverable.balance-amount(@click='setMaxCpuValue') {{cpuWeight}}
          ...
          .row.q-pb-sm.full-width
            ...
            .col-3.text-weight-bold.text-right.cursor-pointer.q-hoverable.balance-amount(@click='setMaxNetValue') {{netWeight}}
